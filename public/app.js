	...
	if(idslst.length > 2)
	{
		...
		$.ajax({
			...
			success: function(data) {
				...
				var listItemsHtml = '';
				listItemsHtml += ('<span style="font-size:13px;font-weight:bold;">'+rowss[0].name+'</span>&nbsp;&nbsp;&nbsp;&nbsp;');
				listItemsHtml += ('<span class="glyphicon glyphicon-pencil" style="cursor: pointer;" onclick="edtsubdeprtmnt()" id="subdepttitlediv" data-id="'+allids+'"></span><div style="width:100%;height:1px;border-bottom: 1px #dddbda solid;"></div>');
